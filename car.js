class Car {
  constructor(x, y, width, height, type, maxSpeed = 3) {
    ...
    if (this.type !== 'dummy') {
      ...
      this.brain = new Network([this.sensor.rawCount, 6, 4])
    }
  ...
  update(roadBorders, traffic) {
    ...
    if (this.sensor) {
      ...
      let offsets = this.sensor.readings.map(s => s == null ? 0 : 1 - s.offset)
      let outputs = Network.feedForward(offsets, this.brain);
      // console.log(outputs);
      if (this.useBrain) {
